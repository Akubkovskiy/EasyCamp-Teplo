...
def guest_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="📞 Связь с админом", callback_data="guest:contact_admin")],
    ])
...
def request_contact_keyboard() -> ReplyKeyboardMarkup:
    ...
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="📱 Найти мою бронь (Поделиться телефоном)", request_contact=True)]
        ],
