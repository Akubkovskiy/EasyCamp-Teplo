...
async def content_menu(callback: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="📍 Изм. Координаты", callback_data="content:edit:coords"
                )
            ],
            [
                InlineKeyboardButton(
                    text="ℹ️ Изм. Правила", callback_data="content:edit:rules"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🧖‍♂️ Изм. Баня/Чан", callback_data="content:edit:bath_info"
                )
            ],
...
async def process_content_edit(message: Message, state: FSMContext):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🔙 В редактор", callback_data="admin:settings:content"
                )
            ]
        ]
    )
