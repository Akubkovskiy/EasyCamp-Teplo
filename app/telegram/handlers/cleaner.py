...
━━━━━━━━━━━━━━━━
💰 <b>ДОПОЛНИТЕЛЬНЫЕ УСЛУГИ И РАСХОДЫ</b>
━━━━━━━━━━━━━━━━
В задаче нажмите <b>«💰 Доп. услуги / расходы»</b>

<b>Регулярные услуги</b> (например «Вывоз белья»):
• Цена фиксирована администратором
• Нажали — начислилось сразу, никакого одобрения не нужно

<b>Разовый расход</b> (заправка газа, починка, покупка):
• Нажмите «💸 Разовый расход»
• Опишите что сделали, укажите сумму
• Администратор одобрит или оспорит — вы получите уведомление
