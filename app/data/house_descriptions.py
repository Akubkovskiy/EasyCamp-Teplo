...
_HOUSES = {
    ...
    "Тепло 3": {
        ...
        "short": (
            "34 м² · до 4 гостей · терраса с видом на горы\n"
            "Лесной домик той же планировки, что и домик №1: тишина, сосны и чистый горный воздух."
        ),
        "full": (
            "🌲 <b>Лесной домик · 34 м²</b>\n\n"
            "Уютный деревянный домик той же планировки, что и домик №1, — с верандой и видом на горы Архызской долины. "
            "Расположен в стороне от посёлка: здесь не слышно машин, зато слышно птиц.\n\n"
            "<b>Удобства:</b>\n"
            "• Двуспальная кровать + диван\n"
            "• Горячий душ и туалет внутри\n"
