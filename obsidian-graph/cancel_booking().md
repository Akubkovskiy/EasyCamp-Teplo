...
## Connections
- [[_cascade_cancel_cleaning()]] - `calls` [EXTRACTED]
- [[_notify_cleaner_about_cancel()]] - `calls` [EXTRACTED]
- [[_safe_background_sheets_sync()]] - `calls` [EXTRACTED]
- [[_unblock_avito_dates()]] - `calls` [EXTRACTED]
